...
INSERT INTO user_table (center_id, email, gender, name, occupation, password, role_id, surname, upin, phone_number, work_status, address_id) values (null, 'john.johnson@gmail.com', 0, 'John',  'Student', '$2a$10$OsT1cBe2WrC7Q8cIH1GRMO6E.xkMA0/iBKcgZ0Ibt1Z9e.rpjxYma', 1, 'Johnson', '0000000000001', '065-1236367', 1, 4);
INSERT INTO user_table (center_id, email, gender, name, occupation, password, role_id, surname, upin, phone_number, work_status, address_id) values (2, 'marko.markovic@gmail.com', 0, 'Marko', null, '$2a$10$OsT1cBe2WrC7Q8cIH1GRMO6E.xkMA0/iBKcgZ0Ibt1Z9e.rpjxYma', 2, 'Markovic', '0000000000002', '062-2645377', 2, 2);
INSERT INTO user_table (center_id, email, gender, name, occupation, password, role_id, surname, upin, phone_number, work_status, address_id) values (null, 'zarko.zarkovic@gmail.com', 0, 'Zarko', null, '$2a$10$OsT1cBe2WrC7Q8cIH1GRMO6E.xkMA0/iBKcgZ0Ibt1Z9e.rpjxYma', 2, 'Zarkovic', '0000000000003', '065-7387897', 2, 5);
INSERT INTO user_table (center_id, email, gender, name, occupation, password, role_id, surname, upin, phone_number, work_status, address_id) values (null, 'marija.marijanovic@gmail.com', 1, 'Marija', null, '$2a$10$OsT1cBe2WrC7Q8cIH1GRMO6E.xkMA0/iBKcgZ0Ibt1Z9e.rpjxYma', 2, 'Marijanovic', '0000000000004', '064-2136597', 2, 7);
INSERT INTO user_table (center_id, email, gender, name, occupation, password, role_id, surname, upin, phone_number, work_status, address_id) values (null, 'nina.ninkovic@gmail.com', 1, 'Nina', null, '$2a$10$OsT1cBe2WrC7Q8cIH1GRMO6E.xkMA0/iBKcgZ0Ibt1Z9e.rpjxYma', 3, 'Ninkovic', '0000000000005', '063-2435632', 2, 6);
...
-- APPOINTMENTS
INSERT INTO appointment (duration, is_reserved, scheduled_time, donator_id, work_calendar_id) values (2, false, '2022-12-21', null, null);
INSERT INTO appointment (duration, is_reserved, scheduled_time, donator_id, work_calendar_id) values (1, false, '2022-12-23', null, null);
